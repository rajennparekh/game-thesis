...
out_dir = 'probing_checkpoints_2head'
...
(num_params, iter_num, epml_by_iter, invalid_rate_by_iter, non_pad_invalid_by_iter,
 ...
 loss_by_iter, val_loss_by_iter, pre_train_probe, post_train_probe) = train(3, 3, 3, n_layer=1, n_head=2, n_embd=12, generate_probing_data=True, output_dir=out_dir)
